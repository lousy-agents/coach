...
func layerViolationChange(key layerPairKey, edges []projectmodel.ImportEdge, layerFromName, layerToName, ruleVersion, backendVersion, configDigest string) ProjectChange {
