...
// Diagnostic reports a problem observed while building a Report, either
// caller-supplied (e.g. from an adapter) or generated by Build itself (e.g.
// "invalid_file_change").
...
// sortDiagnostics sorts diagnostics deterministically by (Path, Kind,
// Location, Message), with nil Location sorting before any non-nil
// Location.
...
// compareLocationPtr orders nil before non-nil, then by (StartRow, StartCol,
// EndRow, EndCol, StartByte, EndByte).
