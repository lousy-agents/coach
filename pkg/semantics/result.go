...
type Finding struct {
	Kind           string   `json:"kind"` // "constructor_func" | "pointer_return" | "mutates_input" | "toctou_check_then_act" (Go); "tight_coupling" | "mutates_input" | "toctou_check_then_act" (TS/TSX)
	Name           string   `json:"name"`
	Location       Location `json:"location"`
