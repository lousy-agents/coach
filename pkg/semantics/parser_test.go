...
func TestValidate_RejectsEmptyContent(t *testing.T) {
	result, err := validate(context.Background(), []byte{}, LanguageGo, 0)
...
func TestValidate_RejectsContentOverMaxFileBytes(t *testing.T) {
	...
	result, err := validate(context.Background(), content, LanguageGo, maxFileBytes)
...
func TestValidate_RejectsContentContainingNULByte(t *testing.T) {
	...
	result, err := validate(context.Background(), content, LanguageGo, 0)
