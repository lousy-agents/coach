...
const goImportQuerySource = `(import_spec path: (_) @import.path)`

// extractGoImports finds every import path under root (single or grouped
// import declarations) using goImportQuerySource, and returns one
