...
export declare const OP_ANALYZE_PROJECT = "analyze_project";
export declare const KIND_BACKEND_UNAVAILABLE = "backend_unavailable";
export declare const KIND_CRASHED = "crashed";
export declare const KIND_INTERNAL = "internal";
export declare const KIND_CANCELED = "canceled";
 ...
 */
export declare const KIND_IMPORT = "import";
export declare const KIND_REEXPORT = "reexport";
export declare const KIND_TYPE_ONLY = "type_only";
export declare const KIND_COMMONJS_REQUIRE = "commonjs_require";
export declare const KIND_DYNAMIC_IMPORT = "dynamic_import";
/**
 ...
 */
export declare const RESOLUTION_SNAPSHOT = "snapshot";
export declare const RESOLUTION_EXTERNAL = "external";
export declare const RESOLUTION_UNRESOLVED = "unresolved";
...
export declare const KIND_POSSIBLE_CALL_REACHABILITY = "possible_call_reachability";
...
export declare const SIDECAR_PHASE = "ts_project_sidecar";
