...
// project-config allowlist ({baseline, output, suggest-project-config}, plus
// project-language when its value is "typescript") rather than enumerating
// every flag known to conflict. Every real codesignal flag today is already
// covered by the acceptance-level "rejected flag combinations" DescribeTable
// in project_config_suggestion_acceptance_test.go; this synthetic flag name
